...
issue](https://github.com/cisagov/ansible-role-geoip2/issues)
...
request](https://github.com/cisagov/ansible-role-geoip2/pulls),
...
```console
cd ansible-role-geoip2
pyenv virtualenv <python_version_to_use> ansible-role-geoip2
pyenv local ansible-role-geoip2
